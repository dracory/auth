...
// LogoutContent builds the HTML for the logout page.
func LogoutContent() string {
...
// LogoutScripts builds the JS for the logout page.
func LogoutScripts(urlApiLogout, urlOnSuccess string) string {
	return `
